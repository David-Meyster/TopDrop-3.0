...
echo _gettext("Continue");
    ...
    {
        return new Source("", "database/structure/bulk_action_modal.twig", "/var/www/admin_topdro_usr/data/www/admin.topdrop.fun/pma/templates/database/structure/bulk_action_modal.twig");
    }
}
